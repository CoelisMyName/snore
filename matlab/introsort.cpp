...
#pragma omp parallel for num_threads(omp_get_max_threads()) private(i)
      ...
      while (st.n > 0) {
        ...
        if (i1 + 1 <= 32) {
          ...
          pow2p = (frame.xstart + i1 / 2) - 1;
          i1 = x[frame.xstart - 1];
          pmax = cmp->workspace.a[x[pow2p] - 1];
          pmin = cmp->workspace.a[i1 - 1];
          varargout_1 = ((pmax < pmin) ||
                         ((pmax == pmin) && (cmp->workspace.b[x[pow2p] - 1] <
                                             cmp->workspace.b[i1 - 1])));
          if (varargout_1) {
          ...
          if (cmp->workspace.a[x[frame.xend - 1] - 1] <
            ...
            varargout_1 = ((cmp->workspace.a[i1] == cmp->workspace.a[pmax]) &&
                           (cmp->workspace.b[i1] < cmp->workspace.b[pmax]));
          }
          if (varargout_1) {
          ...
          if (cmp->workspace.a[x[frame.xend - 1] - 1] <
            ...
            i1 = x[frame.xend - 1] - 1;
            varargout_1 =
                ((cmp->workspace.a[i1] == cmp->workspace.a[x[pow2p] - 1]) &&
                 (cmp->workspace.b[i1] < cmp->workspace.b[x[pow2p] - 1]));
          }
          if (varargout_1) {
            pmax = x[pow2p];
          ...
          do {
            ...
            do {
              exitg3 = 0;
              i1 = cmp->workspace.a[x[pmin] - 1];
              varargout_1 =
                  ((i1 < cmp->workspace.a[pivot]) ||
                   ((i1 == cmp->workspace.a[pivot]) &&
            ...
            do {
              exitg3 = 0;
              i1 = cmp->workspace.a[x[j] - 1];
              varargout_1 =
                  ((cmp->workspace.a[pivot] < i1) ||
                   ((cmp->workspace.a[pivot] == i1) &&
