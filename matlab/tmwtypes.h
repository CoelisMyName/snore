...
/*=======================================================================*
 * Fixed width word length data types:                                     *
 ...
 * In that example, a 32 bit integer length is not even available.
 ...
 * to be the same length.  For example, on many embedded
...
/*===========================================================================*
 * General or logical data types where the word length is not guaranteed.      *
